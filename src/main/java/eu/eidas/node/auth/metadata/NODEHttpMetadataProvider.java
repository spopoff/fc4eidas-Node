 ...
 */
public class NODEHttpMetadataProvider extends HTTPMetadataProvider {
    public NODEHttpMetadataProvider(Timer t, HttpClient client, String url) throws MetadataProviderException {
        super(t, client, url);
    }
