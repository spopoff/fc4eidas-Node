...
public class ColleagueRequestServlet extends AbstractServiceServlet{
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        LOG.debug("controllerService infos: " + controllerService.toString());
        if (controllerService.isAskConsentType()) {
            String versConsent = NodeViewNames.EIDAS_SERVICE_PRESENT_CONSENT.toString();
            LOG.debug("dispachRequest vers="+versConsent);
            RequestDispatcher dispatcher = request.getRequestDispatcher(encodeURL(versConsent, response));
            ...
            LOG.debug("dispachRequest vers="+forwardUrl);
