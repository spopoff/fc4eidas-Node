...
public final class IdPResponseServlet extends AbstractServiceServlet {
  ...
  protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
    ...
    try{
        ...
        String att = null;
        if(attrList==null){
            LOG.error("Erreur liste attributs null");
            throw new NullPointerException("Erreur liste attributs null");
        }
        try {
            att = attrList.toString();
        } catch (Exception e) {
            LOG.error("Erreur dans liste attributs "+e);
            throw new IOException("Erreur dans liste attributs",e);
        }
        if(att==null){
            LOG.error("Erreur dedans liste attributs null");
            throw new IOException("Erreur dedans liste attributs");
        }
