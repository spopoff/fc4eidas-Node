...
public class EidasNodeMetadataGenerator {
    ...
    public String generateConnectorMetadata(){
        LOGGER.debug("generateConnectorMetadata samlServiceSP="+samlServiceSP+" samlServiceIDP="+samlServiceIDP);
    ...
    public String generateServiceMetadata(){
        LOGGER.debug("generateServiceMetadata samlServiceSP="+samlServiceSP+" samlServiceIDP="+samlServiceIDP);
        String loA=null;
    ...
    private String helperGenerateMetadata(String spEngineName, String idpEngineName, String url, String country, String[][] contactsProperties, String siteUrl, String loA){
        ...
        LOGGER.debug("helperGenerateMetadata url="+url+" country="+country);
        if(url!=null && !url.isEmpty()) {
            ...
            LOGGER.error("helperGenerateMetadata rien fait car url="+url+" country="+country);
        }
        return metadata;
    }
